import { Component, Inject, OnInit } from '@angular/core';import { FormBuilder, Validators, AbstractControl } from '@angular/forms';
...
export class EditOrdersComponent implements OnInit {
  ...
  constructor(private form: FormBuilder, private ordersService: OrdersService,
    private http: HttpClient, private dialogRef: MatDialogRef<EditOrdersComponent>,
    @Inject(MAT_DIALOG_DATA) public data:  IDialogData, private salesService: SalesService) { }
