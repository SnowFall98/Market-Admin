...
export class EditProductComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private productsService: ProductsService,
    private form: FormBuilder, private categoriesService: CategoriesService, private router: Router,
    private subcategoriesService: SubcategoriesService, private imagesService: ImagesService) { }
