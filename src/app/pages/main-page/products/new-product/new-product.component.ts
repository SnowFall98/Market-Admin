...
export class NewProductComponent implements OnInit {
	...
	constructor(private form: FormBuilder, private activatedRoute: ActivatedRoute, private productsService: ProductsService, private router: Router,
		private categoriesServices: CategoriesService, private subcategoiresServices: SubcategoriesService, private imagesService: ImagesService) { }
	...
	ngOnInit(): void {
		...
		this.categoriesServices.getData()
		.subscribe(
	...
	selectCategory(e:any){
		...
		this.categories.filter((category:any)=>{
			...
			if(category.name == e.target.value.split("_")[1]){
				...
				this.subcategoiresServices.getFilterData("category", category.name)
				.subscribe(
