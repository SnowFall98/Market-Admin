...
import { IDialogData } from '../../categories/edit-categories/edit-categories.component';
...
export class ApproveProductComponent implements OnInit {
  ...
  constructor(private form: FormBuilder, private http: HttpClient, private storesService: StoresService,
    private productsService: ProductsService, public dialogRef: MatDialogRef<ApproveProductComponent>,
