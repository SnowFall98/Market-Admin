...
export class NewSubcategoriesComponent implements OnInit {
	...
	constructor(private form: FormBuilder, private subcategoriesService: SubcategoriesService, 
		public dialogRef: MatDialogRef<NewSubcategoriesComponent>,  private categoriesService: CategoriesService) { }
